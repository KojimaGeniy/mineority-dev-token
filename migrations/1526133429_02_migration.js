...
module.exports = function(deployer) {
  deployer.deploy(Mineority).then(() => {
    Mineority.deployed().then((instance) => {
      ...
      instance.setCFO("0x1677D1d23064a19cB630706A2eF48251D8c2d3F2",{ from: accounts[0] });      
      return instance.setCTO("0x68b2246b8969CA71069f7b3ff97B90F708de6064",{from: accounts[0]});});
  });
};
